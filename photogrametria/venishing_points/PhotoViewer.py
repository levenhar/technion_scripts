...
def drawImageFrame(imageWidth, imageHeight, R, x0, f, scale, ax):
    ...
    P=x0-R@np.array([[0],[0],[scale*-f]])
    ax.plot([x0[0,0],P[0,0]],[x0[1,0],P[1,0]],[x0[2,0],P[2,0]],"r")
...
def CubeDrawing(Cube,ax):
    Cor=Cube.corner
    ax.plot([Cor[0, 0], Cor[1, 0]], [Cor[0, 1], Cor[1, 1]], [Cor[0, 2], Cor[1, 2]],"black")
    ax.plot([Cor[2, 0], Cor[1, 0]], [Cor[2, 1], Cor[1, 1]], [Cor[2, 2], Cor[1, 2]],"black")
    ax.plot([Cor[2, 0], Cor[4, 0]], [Cor[2, 1], Cor[4, 1]], [Cor[2, 2], Cor[4, 2]],"black")
    ax.plot([Cor[0, 0], Cor[4, 0]], [Cor[0, 1], Cor[4, 1]], [Cor[0, 2], Cor[4, 2]],"black")
    ax.plot([Cor[0, 0], Cor[6, 0]], [Cor[0, 1], Cor[6, 1]], [Cor[0, 2], Cor[6, 2]],"black")
    ax.plot([Cor[7, 0], Cor[6, 0]], [Cor[7, 1], Cor[6, 1]], [Cor[7, 2], Cor[6, 2]],"black")
    ax.plot([Cor[7, 0], Cor[3, 0]], [Cor[7, 1], Cor[3, 1]], [Cor[7, 2], Cor[3, 2]],"black")
    ax.plot([Cor[1, 0], Cor[7, 0]], [Cor[1, 1], Cor[7, 1]], [Cor[1, 2], Cor[7, 2]],"black")
    ax.plot([Cor[2, 0], Cor[3, 0]], [Cor[2, 1], Cor[3, 1]], [Cor[2, 2], Cor[3, 2]],"black")
    ax.plot([Cor[5, 0], Cor[3, 0]], [Cor[5, 1], Cor[3, 1]], [Cor[5, 2], Cor[3, 2]],"black")
    ax.plot([Cor[5, 0], Cor[4, 0]], [Cor[5, 1], Cor[4, 1]], [Cor[5, 2], Cor[4, 2]],"black")
    ax.plot([Cor[5, 0], Cor[6, 0]], [Cor[5, 1], Cor[6, 1]], [Cor[5, 2], Cor[6, 2]],"black")
